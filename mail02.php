...
$require = array('会社名','所属部門','役職','氏名','メールアドレス','電話番号','お問い合わせの目的','個人情報保護方針');
...
$re_subject = "【カソーク】お問い合わせありがとうございました";
...
この度はカソークにお問い合わせいただき、誠にありがとうございます。
